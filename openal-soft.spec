...
Source0  : https://www.openal-soft.org/openal-releases/openal-soft-1.24.2.tar.bz2
...
%prep
%setup -q -n openal-soft-1.24.2
cd %{_builddir}/openal-soft-1.24.2
pushd ..
cp -a openal-soft-1.24.2 build32
popd
pushd ..
cp -a openal-soft-1.24.2 buildavx2
popd
pushd ..
cp -a openal-soft-1.24.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736800660
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libopenal.so.1.24.2
/V4/usr/lib64/libopenal.so.1.24.2
/usr/lib64/libopenal.so.1
/usr/lib64/libopenal.so.1.24.2
