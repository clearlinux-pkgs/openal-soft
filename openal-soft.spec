...
Source0  : https://www.openal-soft.org/openal-releases/openal-soft-1.24.3.tar.bz2
...
%prep
%setup -q -n openal-soft-1.24.3
cd %{_builddir}/openal-soft-1.24.3
pushd ..
cp -a openal-soft-1.24.3 build32
popd
pushd ..
cp -a openal-soft-1.24.3 buildavx2
popd
pushd ..
cp -a openal-soft-1.24.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743429473
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/openal-soft-%{version}/fmt-11.1.1/LICENSE %{buildroot}/usr/share/package-licenses/openal-soft/1606b4a09dd264124a044831841a83c68a2b9126 || :
cp %{_builddir}/openal-soft-%{version}/fmt-11.1.1/doc/python-license.txt %{buildroot}/usr/share/package-licenses/openal-soft/f19fa3302647d3061306ffb9ef072a777c166e0b || :
export GOAMD64=v2
pushd ../build32/
pushd clr-build32
%make_install32
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libopenal.so.1.24.3
/V4/usr/lib64/libopenal.so.1.24.3
/usr/lib64/libopenal.so.1
/usr/lib64/libopenal.so.1.24.3

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libopenal.so.1
/usr/lib32/libopenal.so.1.24.3
