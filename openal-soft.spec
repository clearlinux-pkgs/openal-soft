...
Source0  : https://www.openal-soft.org/openal-releases/openal-soft-1.23.0.tar.bz2
...
%prep
%setup -q -n openal-soft-1.23.0
cd %{_builddir}/openal-soft-1.23.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675633637
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libopenal.so.1.23.0
/usr/lib64/glibc-hwcaps/x86-64-v4/libopenal.so.1
/usr/lib64/glibc-hwcaps/x86-64-v4/libopenal.so.1.23.0
/usr/lib64/libopenal.so.1
/usr/lib64/libopenal.so.1.23.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libopenal.so.1
/usr/lib32/libopenal.so.1.23.0
