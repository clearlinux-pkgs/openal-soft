...
%prep
%setup -q -n openal-soft-1.22.2
cd %{_builddir}/openal-soft-1.22.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656341948
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/openal-soft-1.22.2/COPYING %{buildroot}/usr/share/package-licenses/openal-soft/707b40a3e29fae6db61aa9620879f003fdda4ed2
pushd clr-build32
%make_install32
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libopenal.so.1.22.2
/usr/lib64/glibc-hwcaps/x86-64-v4/libopenal.so.1
/usr/lib64/glibc-hwcaps/x86-64-v4/libopenal.so.1.22.2
