...
Source0  : https://www.openal-soft.org/openal-releases/openal-soft-1.21.1.tar.bz2
...
%prep
%setup -q -n openal-soft-1.21.1
cd %{_builddir}/openal-soft-1.21.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644263027
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/openal-soft-1.21.1/COPYING %{buildroot}/usr/share/package-licenses/openal-soft/707b40a3e29fae6db61aa9620879f003fdda4ed2
pushd clr-build32
%make_install32
