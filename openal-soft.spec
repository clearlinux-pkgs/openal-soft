...
Source0  : https://www.openal-soft.org/openal-releases/openal-soft-1.22.0.tar.bz2
...
%prep
%setup -q -n openal-soft-1.22.0
cd %{_builddir}/openal-soft-1.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651694542
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/openal-soft-1.22.0/COPYING %{buildroot}/usr/share/package-licenses/openal-soft/707b40a3e29fae6db61aa9620879f003fdda4ed2
pushd clr-build32
%make_install32
...
/usr/lib64/libopenal.so.1.22.0
/usr/share/clear/optimized-elf/lib*

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libopenal.so.1
/usr/lib32/libopenal.so.1.22.0
